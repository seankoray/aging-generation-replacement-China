****************************************************
* Supplementary Information: HAPC Model for TFP
* Mixed-effects model with year and village random effects
****************************************************
...
*---------------------------------------------------
* 3) HAPC regression (mixed effects)
*---------------------------------------------------
mixed lntfp ///
    i.age_group1 i.cohort_group ///
...
* Export coefficients
esttab hapc using "./output/table_hapc_fixed.tex", replace ///
    b(%9.3f) se(%9.3f) ///
    star(* 0.10 ** 0.05 *** 0.01) ///
    label ///
    compress ///
    booktabs ///
    nomtitles nonotes ///
    title("HAPC estimates of log grain productivity") ///
    addnotes("Robust standard errors clustered at the year level.","Age group base: 16-25; Cohort group base: 1920-1929.")
...
* Age curve
margins age_group1, atmeans level(95)
...
marginsplot, ///
    ...
    xtitle("Age group") ///
    ytitle("ln(TFP)") ///
    name(g_age_hapc, replace)

* Cohort curve
margins cohort_group, atmeans level(95)
...
marginsplot, ///
    ...
    xtitle("Cohort group") ///
    ytitle("ln(TFP)") ///
    name(g_cohort_hapc, replace)

*---------------------------------------------------
* 5) Combine and export
*---------------------------------------------------
graph combine g_age_hapc g_cohort_hapc, ///
    col(1) ///
    ysize(15) xsize(12) ///
    imargin(small) ///
    ycommon ///
...
graph export "./output/SI_HAPC.pdf", replace
